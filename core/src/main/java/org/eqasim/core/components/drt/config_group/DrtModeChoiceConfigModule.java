...
public class DrtModeChoiceConfigModule extends AbstractEqasimExtension {

    DrtModeChoiceConfigGroup drtDmcConfig;
    private final CommandLine cmd;

    public DrtModeChoiceConfigModule(CommandLine cmd, DrtModeChoiceConfigGroup drtDmcConfig) {
