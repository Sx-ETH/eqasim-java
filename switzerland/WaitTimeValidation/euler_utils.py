...
def read_output(output_directory, last_iter):
    drt_legs = []
    global_avg = []
    global_moving_avg = []
    ...
    d = {'drt_legs': drt_legs, 'global_avg': global_avg, 'global_moving_avg': global_moving_avg, 'global_successive_avg': global_successive_avg, 'zonal_avg': zonal_avg, 'zonal_moving_avg': zonal_moving_avg, 'zonal_successive_avg': zonal_successive_avg, 'drt_trips_stats': drt_trips_stats, 'link2zones': link2zones}
    return d
