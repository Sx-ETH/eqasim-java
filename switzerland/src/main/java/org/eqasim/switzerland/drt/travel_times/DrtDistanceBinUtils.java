...
public class DrtDistanceBinUtils {
    ...
    private final int maxDistance_m;
    ...
    public DrtDistanceBinUtils(int distanceBinSize_m, int maxDistance_m) {
        ...
        if (this.distanceBinSize_m == -1) {
            ...
            this.nDistanceBins = (int) Math.ceil((double) this.maxDistance_m / this.distanceBinSize_m) + 1;
